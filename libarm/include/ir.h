...
#define ARM_DP_CMP(_) (010 == (~3 & (_)))
#define ARM_DP_MOV(_) (015 == (~2 & (_)))

#define ARM_IR4 ARM_IR_BIT(4)
#define ARM_IR7 ARM_IR_BIT(7)

#define ARM_IR_4and7 (ARM_IR4 && ARM_IR7)
...
#define ARM_IR_DP_CMP (ARM_IR_DP_S && ARM_DP_CMP(ARM_IR_DP_OPCODE))
#define ARM_IR_DP_I bext32(IR, 4)
#define ARM_IR_DP_FLAG_SPC (ARM_IR_DP_S && rR_IS_NOT_PC(D))
#define ARM_IR_DP_MOV ARM_DP_MOV(ARM_IR_DP_OPCODE)
...
#define ARM_IR_DPI_MOV (ARM_IR_DPI && ARM_IR_DP_MOV)
#define ARM_IR_DPI_ROTATE_AMOUNT mlBFMOV(IR, 11, 8, 1)
#define ARM_IR_DPI_IMMEDIATE mlBFEXT(IR, 7, 0)

enum {
	ARM_IR_LDST_BIT_I = 25, ARM_IR_LDST_BIT_i25 = ARM_IR_LDST_BIT_I,
	ARM_IR_LDST_BIT_P = 24, ARM_IR_LDST_BIT_p24 = ARM_IR_LDST_BIT_P,
	ARM_IR_LDST_BIT_U = 23, ARM_IR_LDST_BIT_u23 = ARM_IR_LDST_BIT_U,
	ARM_IR_LDST_BIT_B = 22, ARM_IR_LDST_BIT_b22 = ARM_IR_LDST_BIT_B,
	ARM_IR_LDST_BIT_W = 21, ARM_IR_LDST_BIT_w21 = ARM_IR_LDST_BIT_W,
	ARM_IR_LDST_BIT_L = 20, ARM_IR_LDST_BIT_l20 = ARM_IR_LDST_BIT_L,
};

#define ARM_IR_LDST_BIT(_x) bext32(IR, ARM_IR_LDST_BIT_##_x)
#define ARM_IR_LDST_FLAG_T (!ARM_IR_LDST_BIT(P) && ARM_IR_LDST_BIT(W))
#define ARM_IR_LDST_FLAG_WB(_) ARM_IR_LDST_FLAG_WB_##_
#define ARM_IR_LDST_FLAG_WB_D ARM_IR_LDST_BIT(L)
#define ARM_IR_LDST_FLAG_WB_N (!ARM_IR_LDST_FLAG_T && (!ARM_IR_LDST_BIT(P) || ARM_IR_LDST_BIT(W)))
#define ARM_IR_LDST_IMMEDIATE_OFFSET mlBFEXT(IR, 11, 0)
#define ARM_IR_LDST_IPUBWL mlBFEXT(IR, 25, 20)

enum {
	ARM_IR_LDSTM_BIT_S = 22, ARM_IR_LDSTM_BIT_s22 = ARM_IR_LDSTM_BIT_S,
...
enum {
	ARM_IR_LDST_SH_BIT_I = 22, ARM_IR_LDST_SH_BIT_i22 = ARM_IR_LDST_SH_BIT_I,
	ARM_IR_LDST_SH_BIT_S = 6, ARM_IR_LDST_SH_BIT_s6 = ARM_IR_LDST_SH_BIT_S,
	ARM_IR_LDST_SH_BIT_H = 5, ARM_IR_LDST_SH_BIT_h5 = ARM_IR_LDST_SH_BIT_H,
};
