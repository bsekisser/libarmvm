...
#define ARM_IR_4and7 (btst32(IR, 4) && btst32(IR, 7))

#define ARM_IR_BIT(_x) bext32(IR, _x)
...
#define ARM_IR_B_LINK bext32(IR, 24)
...
#define ARM_IR_DPI bext32(IR, 25)
...
#define ARM_IR_LDST_BIT(_x) bext32(IR, ARM_IR_LDST_BIT_##_x)
...
#define ARM_IR_LDSTM_BIT(_x) bext32(IR, ARM_IR_LDSTM_BIT_##_x)
...
#define ARM_IR_LDST_SH_BIT(_x) bext32(IR, ARM_IR_LDST_SH_BIT_ ## _x)
